...
contract Deploy is Script {
    ...
    function _deployAggregators(address oracle) internal {
        ...
        KaskadAggregatorV3 tibbirAgg = new KaskadAggregatorV3(oracle, keccak256("TIBBIR/USD"), "TIBBIR / USD");
        ...
        console.log("TIBBIR/USD Aggregator:", address(tibbirAgg));
    }
}
